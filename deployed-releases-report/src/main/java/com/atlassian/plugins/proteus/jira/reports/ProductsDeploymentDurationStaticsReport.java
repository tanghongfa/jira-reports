 ...
 */
public class ProductsDeploymentDurationStaticsReport extends AbstractReport {
    private static final Logger log = Logger.getLogger(ProductsDeploymentDurationStaticsReport.class);
     ...
     */
    public ProductsDeploymentDurationStaticsReport(SearchProvider searchProvider, DateTimeFormatter dateTimeFormatter,
